...
export function ClientPortalSidebar() {
  ...
  const navigation = [
    { name: 'דשבורד ראשי', href: '/client-portal', icon: LayoutDashboard },
    { name: 'משרות ומועמדים', href: '/client-portal/jobs', icon: Briefcase },
    { name: 'הזמנות וחיובים', href: '/client-portal/billing', icon: FileText },
    { name: 'צ\'אט', href: '/client-portal/chat', icon: MessageSquare },
  ];
        ...
        <div className="flex items-center justify-between">
          {!collapsed && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">פורטל לקוח</h1>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-sm text-gray-900">שרה כהן</p>
                <p className="text-xs text-gray-500">חברת טכנולוגיה א</p>
              </div>
            </div>
